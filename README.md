...
if you want to test gatito linux with less than 17mb of ram, i recommend you to change the bios, in qemu you use -bios to change, although i will NOT help any errors ocurred at any other bios. (it needs to be an legacy bios for obvious reasons)
